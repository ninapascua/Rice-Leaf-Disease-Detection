...
MODEL_OUTPUT_PATH = Path("experiments/results/ablations/best_efficientnetb0_no_class_weights.keras")
HISTORY_OUTPUT_PATH = Path("experiments/logs/ablations/training_history_no_class_weights.json")
CLASS_NAMES_OUTPUT_PATH = Path("experiments/logs/ablations/class_names_no_class_weights.json")
...
def main():
    ...
    combined_history["ablation"] = "no_class_weights"
